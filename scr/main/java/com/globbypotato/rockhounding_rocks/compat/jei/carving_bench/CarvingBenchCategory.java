...
public class CarvingBenchCategory extends RHRecipeCategory {
	...
	public CarvingBenchCategory(IGuiHelper guiHelper, String uid) {
	...
	public void setRecipe(IRecipeLayout recipeLayout, IRecipeWrapper recipeWrapper, IIngredients ingredients) {
		...
		CarvingBenchWrapper wrapper = (CarvingBenchWrapper) recipeWrapper;
