...
public class ModConfig {
	...
	public static void loadConfig(FMLPreInitializationEvent event) {
		...
		CAN_USE_CUTTING_STATION = config.get(				"Absolute_misc",		"Cutting Station", 		true,	"Wether to allow the use of the Advanced Cutting Station").getBoolean();
		CAN_USE_FOUNTAINS = config.get(						"Absolute_misc",		"Fountains Water", 		true,	"Wether water in fountains can be used").getBoolean();
		CAN_PILLARS_BLEND = config.get(						"Absolute_misc",		"Blending Pillars", 	true,	"Wether different rocks extend the same column or make a new one").getBoolean();
		...
		ENABLE_SCULPT = config.get(							"Absolute_settings",	"All Pillars", 			true,	"Enable/Disable all the pillars").getBoolean();
		ENABLE_VANILLA = config.get(						"Absolute_settings",	"Vanilla Blocks", 		true,	"Enable/Disable this block").getBoolean();
		ENABLE_CLAY = config.get(							"Absolute_settings",	"Terracotta Blocks", 	true,	"Enable/Disable this block").getBoolean();
		ENABLE_CONCRETE = config.get(						"Absolute_settings",	"Concrete Blocks", 		true,	"Enable/Disable this block").getBoolean();
		...
		ENABLE_PAVES = config.get(							"Absolute_parts",		"Pave", 				true,	"Enable/Disable this block").getBoolean();
		...
		ENABLE_PEDESTALS = config.get(						"Absolute_parts",		"Pedestals", 			true,	"Enable/Disable this block").getBoolean();
		...
		ENABLE_STELE = config.get(							"Absolute_parts",		"Stele", 				true,	"Enable/Disable this block").getBoolean();
		ENABLE_TWISTED = config.get(						"Absolute_parts",		"Twisted Column", 		true,	"Enable/Disable this block").getBoolean();
		...
		RocksGenerator.ROCKS_FREQUENCY[101]  = config.get(	"Diatomite", 			"Frequency", 	7).getInt();
			RocksGenerator.ROCKS_BIOME[101]  = config.get(	"Diatomite", 			"Biome type", 	"BEACH").getString();
		 RocksGenerator.ROCKS_MIN_SIZE[101]  = config.get(	"Diatomite", 			"Min Size", 	4).getInt();
		 RocksGenerator.ROCKS_MAX_SIZE[101]  = config.get(	"Diatomite", 			"Max Size",		16).getInt();
		 RocksGenerator.ROCKS_MIN_VEIN[101]  = config.get(	"Diatomite", 			"Min level", 	54).getInt();
		 RocksGenerator.ROCKS_MAX_VEIN[101]  = config.get(	"Diatomite", 			"Max level",	70).getInt();
		...
		RocksGenerator.ROCKS_FREQUENCY[112]  = config.get(	"Apache Rhyolite", 		"Frequency", 	7).getInt();
			RocksGenerator.ROCKS_BIOME[112]  = config.get(	"Apache Rhyolite", 		"Biome type", 	"JUNGLE").getString();
		 RocksGenerator.ROCKS_MIN_SIZE[112]  = config.get(	"Apache Rhyolite", 		"Min Size", 	4).getInt();
		 RocksGenerator.ROCKS_MAX_SIZE[112]  = config.get(	"Apache Rhyolite", 		"Max Size",		12).getInt();
		 RocksGenerator.ROCKS_MIN_VEIN[112]  = config.get(	"Apache Rhyolite", 		"Min level", 	25).getInt();
		 RocksGenerator.ROCKS_MAX_VEIN[112]  = config.get(	"Apache Rhyolite", 		"Max level",	39).getInt();

		RocksGenerator.ROCKS_FREQUENCY[113]  = config.get(	"Ammolite",	 			"Frequency", 	4).getInt();
			RocksGenerator.ROCKS_BIOME[113]  = config.get(	"Ammolite", 			"Biome type", 	"BEACH").getString();
		 RocksGenerator.ROCKS_MIN_SIZE[113]  = config.get(	"Ammolite", 			"Min Size", 	4).getInt();
		 RocksGenerator.ROCKS_MAX_SIZE[113]  = config.get(	"Ammolite", 			"Max Size",		12).getInt();
		 RocksGenerator.ROCKS_MIN_VEIN[113]  = config.get(	"Ammolite", 			"Min level", 	40).getInt();
		 RocksGenerator.ROCKS_MAX_VEIN[113]  = config.get(	"Ammolite", 			"Max level",	70).getInt();

		RocksGenerator.ROCKS_FREQUENCY[114]  = config.get(	"Dendritic Opal",	 	"Frequency", 	6).getInt();
			RocksGenerator.ROCKS_BIOME[114]  = config.get(	"Dendritic Opal", 		"Biome type", 	"SANDY").getString();
		 RocksGenerator.ROCKS_MIN_SIZE[114]  = config.get(	"Dendritic Opal", 		"Min Size", 	4).getInt();
		 RocksGenerator.ROCKS_MAX_SIZE[114]  = config.get(	"Dendritic Opal", 		"Max Size",		12).getInt();
		 RocksGenerator.ROCKS_MIN_VEIN[114]  = config.get(	"Dendritic Opal", 		"Min level", 	40).getInt();
		 RocksGenerator.ROCKS_MAX_VEIN[114]  = config.get(	"Dendritic Opal", 		"Max level",	70).getInt();

		RocksGenerator.ROCKS_FREQUENCY[115]  = config.get(	"Oolite",			 	"Frequency", 	7).getInt();
			RocksGenerator.ROCKS_BIOME[115]  = config.get(	"Oolite", 				"Biome type", 	"OCEAN").getString();
		 RocksGenerator.ROCKS_MIN_SIZE[115]  = config.get(	"Oolite", 				"Min Size", 	4).getInt();
		 RocksGenerator.ROCKS_MAX_SIZE[115]  = config.get(	"Oolite", 				"Max Size",		12).getInt();
		 RocksGenerator.ROCKS_MIN_VEIN[115]  = config.get(	"Oolite", 				"Min level", 	30).getInt();
		 RocksGenerator.ROCKS_MAX_VEIN[115]  = config.get(	"Oolite", 				"Max level",	60).getInt();

		RocksGenerator.ROCKS_FREQUENCY[116]  = config.get(	"Gray Schist",		 	"Frequency", 	9).getInt();
			RocksGenerator.ROCKS_BIOME[116]  = config.get(	"Gray Schist", 			"Biome type", 	"HILLS").getString();
		 RocksGenerator.ROCKS_MIN_SIZE[116]  = config.get(	"Gray Schist", 			"Min Size", 	4).getInt();
		 RocksGenerator.ROCKS_MAX_SIZE[116]  = config.get(	"Gray Schist", 			"Max Size",		14).getInt();
		 RocksGenerator.ROCKS_MIN_VEIN[116]  = config.get(	"Gray Schist", 			"Min level", 	70).getInt();
		 RocksGenerator.ROCKS_MAX_VEIN[116]  = config.get(	"Gray Schist", 			"Max level",	89).getInt();

		RocksGenerator.ROCKS_FREQUENCY[117]  = config.get(	"Guadalupe Jasper",		"Frequency", 	4).getInt();
			RocksGenerator.ROCKS_BIOME[117]  = config.get(	"Guadalupe Jasper", 	"Biome type", 	"MAGICAL").getString();
		 RocksGenerator.ROCKS_MIN_SIZE[117]  = config.get(	"Guadalupe Jasper", 	"Min Size", 	4).getInt();
		 RocksGenerator.ROCKS_MAX_SIZE[117]  = config.get(	"Guadalupe Jasper", 	"Max Size",		14).getInt();
		 RocksGenerator.ROCKS_MIN_VEIN[117]  = config.get(	"Guadalupe Jasper", 	"Min level", 	70).getInt();
		 RocksGenerator.ROCKS_MAX_VEIN[117]  = config.get(	"Guadalupe Jasper", 	"Max level",	89).getInt();

		RocksGenerator.ROCKS_FREQUENCY[118]  = config.get(	"Tree Agate",			"Frequency", 	5).getInt();
			RocksGenerator.ROCKS_BIOME[118]  = config.get(	"Tree Agate", 			"Biome type", 	"SWAMP").getString();
		 RocksGenerator.ROCKS_MIN_SIZE[118]  = config.get(	"Tree Agate", 			"Min Size", 	4).getInt();
		 RocksGenerator.ROCKS_MAX_SIZE[118]  = config.get(	"Tree Agate", 			"Max Size",		14).getInt();
		 RocksGenerator.ROCKS_MIN_VEIN[118]  = config.get(	"Tree Agate", 			"Min level", 	70).getInt();
		 RocksGenerator.ROCKS_MAX_VEIN[118]  = config.get(	"Tree Agate", 			"Max level",	89).getInt();

		RocksGenerator.ROCKS_FREQUENCY[119]  = config.get(	"Blue Schist",			"Frequency", 	9).getInt();
			RocksGenerator.ROCKS_BIOME[119]  = config.get(	"Blue Schist", 			"Biome type", 	"MOUNTAIN").getString();
		 RocksGenerator.ROCKS_MIN_SIZE[119]  = config.get(	"Blue Schist", 			"Min Size", 	4).getInt();
		 RocksGenerator.ROCKS_MAX_SIZE[119]  = config.get(	"Blue Schist", 			"Max Size",		10).getInt();
		 RocksGenerator.ROCKS_MIN_VEIN[119]  = config.get(	"Blue Schist", 			"Min level", 	120).getInt();
		 RocksGenerator.ROCKS_MAX_VEIN[119]  = config.get(	"Blue Schist", 			"Max level",	170).getInt();

		RocksGenerator.ROCKS_FREQUENCY[120]  = config.get(	"Umber",				"Frequency", 	8).getInt();
			RocksGenerator.ROCKS_BIOME[120]  = config.get(	"Umber", 				"Biome type", 	"WASTELAND").getString();
		 RocksGenerator.ROCKS_MIN_SIZE[120]  = config.get(	"Umber", 				"Min Size", 	4).getInt();
		 RocksGenerator.ROCKS_MAX_SIZE[120]  = config.get(	"Umber", 				"Max Size",		10).getInt();
		 RocksGenerator.ROCKS_MIN_VEIN[120]  = config.get(	"Umber", 				"Min level", 	50).getInt();
		 RocksGenerator.ROCKS_MAX_VEIN[120]  = config.get(	"Umber", 				"Max level",	70).getInt();

		RocksGenerator.ROCKS_FREQUENCY[121]  = config.get(	"Breccia",				"Frequency", 	10).getInt();
			RocksGenerator.ROCKS_BIOME[121]  = config.get(	"Breccia", 				"Biome type", 	"HOT").getString();
		 RocksGenerator.ROCKS_MIN_SIZE[121]  = config.get(	"Breccia", 				"Min Size", 	4).getInt();
		 RocksGenerator.ROCKS_MAX_SIZE[121]  = config.get(	"Breccia", 				"Max Size",		10).getInt();
		 RocksGenerator.ROCKS_MIN_VEIN[121]  = config.get(	"Breccia", 				"Min level", 	15).getInt();
		 RocksGenerator.ROCKS_MAX_VEIN[121]  = config.get(	"Breccia", 				"Max level",	30).getInt();

		RocksGenerator.ROCKS_FREQUENCY[122]  = config.get(	"Actinolite",			"Frequency", 	8).getInt();
			RocksGenerator.ROCKS_BIOME[122]  = config.get(	"Actinolite", 			"Biome type", 	"SANDY").getString();
		 RocksGenerator.ROCKS_MIN_SIZE[122]  = config.get(	"Actinolite", 			"Min Size", 	4).getInt();
		 RocksGenerator.ROCKS_MAX_SIZE[122]  = config.get(	"Actinolite", 			"Max Size",		10).getInt();
		 RocksGenerator.ROCKS_MIN_VEIN[122]  = config.get(	"Actinolite", 			"Min level", 	16).getInt();
		 RocksGenerator.ROCKS_MAX_VEIN[122]  = config.get(	"Actinolite", 			"Max level",	34).getInt();

		RocksGenerator.ROCKS_FREQUENCY[123]  = config.get(	"Madagascar Rhyolite",	"Frequency", 	6).getInt();
			RocksGenerator.ROCKS_BIOME[123]  = config.get(	"Madagascar Rhyolite", 	"Biome type", 	"FOREST").getString();
		 RocksGenerator.ROCKS_MIN_SIZE[123]  = config.get(	"Madagascar Rhyolite", 	"Min Size", 	4).getInt();
		 RocksGenerator.ROCKS_MAX_SIZE[123]  = config.get(	"Madagascar Rhyolite", 	"Max Size",		10).getInt();
		 RocksGenerator.ROCKS_MIN_VEIN[123]  = config.get(	"Madagascar Rhyolite", 	"Min level", 	17).getInt();
		 RocksGenerator.ROCKS_MAX_VEIN[123]  = config.get(	"Madagascar Rhyolite", 	"Max level",	33).getInt();

		RocksGenerator.ROCKS_FREQUENCY[124]  = config.get(	"Wonderstone",			"Frequency", 	6).getInt();
			RocksGenerator.ROCKS_BIOME[124]  = config.get(	"Wonderstone",		 	"Biome type", 	"PLAIN").getString();
		 RocksGenerator.ROCKS_MIN_SIZE[124]  = config.get(	"Wonderstone", 			"Min Size", 	4).getInt();
		 RocksGenerator.ROCKS_MAX_SIZE[124]  = config.get(	"Wonderstone", 			"Max Size",		10).getInt();
		 RocksGenerator.ROCKS_MIN_VEIN[124]  = config.get(	"Wonderstone", 			"Min level", 	17).getInt();
		 RocksGenerator.ROCKS_MAX_VEIN[124]  = config.get(	"Wonderstone", 			"Max level",	33).getInt();

		RocksGenerator.ROCKS_FREQUENCY[125]  = config.get(	"Opal",					"Frequency", 	6).getInt();
			RocksGenerator.ROCKS_BIOME[125]  = config.get(	"Opal",				 	"Biome type", 	"SAVANNA").getString();
		 RocksGenerator.ROCKS_MIN_SIZE[125]  = config.get(	"Opal", 				"Min Size", 	4).getInt();
		 RocksGenerator.ROCKS_MAX_SIZE[125]  = config.get(	"Opal", 				"Max Size",		10).getInt();
		 RocksGenerator.ROCKS_MIN_VEIN[125]  = config.get(	"Opal", 				"Min level", 	14).getInt();
		 RocksGenerator.ROCKS_MAX_VEIN[125]  = config.get(	"Opal", 				"Max level",	33).getInt();

		RocksGenerator.ROCKS_FREQUENCY[126]  = config.get(	"Apatite",				"Frequency", 	6).getInt();
			RocksGenerator.ROCKS_BIOME[126]  = config.get(	"Apatite",			 	"Biome type", 	"COLD").getString();
		 RocksGenerator.ROCKS_MIN_SIZE[126]  = config.get(	"Apatite", 				"Min Size", 	4).getInt();
		 RocksGenerator.ROCKS_MAX_SIZE[126]  = config.get(	"Apatite", 				"Max Size",		10).getInt();
		 RocksGenerator.ROCKS_MIN_VEIN[126]  = config.get(	"Apatite", 				"Min level", 	15).getInt();
		 RocksGenerator.ROCKS_MAX_VEIN[126]  = config.get(	"Apatite", 				"Max level",	36).getInt();

		RocksGenerator.ROCKS_FREQUENCY[127]  = config.get(	"Eclogite",				"Frequency", 	6).getInt();
			RocksGenerator.ROCKS_BIOME[127]  = config.get(	"Eclogite",			 	"Biome type", 	"MESA").getString();
		 RocksGenerator.ROCKS_MIN_SIZE[127]  = config.get(	"Eclogite", 			"Min Size", 	4).getInt();
		 RocksGenerator.ROCKS_MAX_SIZE[127]  = config.get(	"Eclogite", 			"Max Size",		10).getInt();
		 RocksGenerator.ROCKS_MIN_VEIN[127]  = config.get(	"Eclogite", 			"Min level", 	13).getInt();
		 RocksGenerator.ROCKS_MAX_VEIN[127]  = config.get(	"Eclogite", 			"Max level",	35).getInt();
