...
public class BaseTetras extends DecoIO{
    public static final PropertyEnum POS = PropertyEnum.create("pos", EnumPos.class);

	public BaseTetras(String name, Material material, String[] array, float hardness, float resistance, SoundType stepSound) {
