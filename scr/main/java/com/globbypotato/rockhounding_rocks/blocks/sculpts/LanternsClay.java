...
public class LanternsClay extends LanternsIO {
	public static final PropertyEnum VARIANT = PropertyEnum.create("type", EnumClay.class);

    public LanternsClay(String[] array, String name){
		...
		this.setDefaultState(this.blockState.getBaseState().withProperty(VARIANT, EnumClay.values()[0]).withProperty(SUPPORT, EnumSupport.FULL));
    }
