...
public class LanternsA extends LanternsIO {
	public static final PropertyEnum VARIANT = PropertyEnum.create("type", EnumRocksA.class);

    public LanternsA(String[] array, String name){
		...
		this.setDefaultState(this.blockState.getBaseState().withProperty(VARIANT, EnumRocksA.values()[0]).withProperty(SUPPORT, EnumSupport.FULL));
    }
