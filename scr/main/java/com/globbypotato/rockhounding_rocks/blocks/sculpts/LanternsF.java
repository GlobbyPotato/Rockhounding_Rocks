...
public class LanternsF extends LanternsIO {
	public static final PropertyEnum VARIANT = PropertyEnum.create("type", EnumRocksF.class);

    public LanternsF(String[] array, String name){
		...
		this.setDefaultState(this.blockState.getBaseState().withProperty(VARIANT, EnumRocksF.values()[0]).withProperty(SUPPORT, EnumSupport.FULL));
    }
