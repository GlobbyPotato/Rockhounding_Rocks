...
public class LanternsB extends LanternsIO {
	public static final PropertyEnum VARIANT = PropertyEnum.create("type", EnumRocksB.class);

    public LanternsB(String[] array, String name){
		...
		this.setDefaultState(this.blockState.getBaseState().withProperty(VARIANT, EnumRocksB.values()[0]).withProperty(SUPPORT, EnumSupport.FULL));
    }
