...
public class LanternsD extends LanternsIO {
	public static final PropertyEnum VARIANT = PropertyEnum.create("type", EnumRocksD.class);

    public LanternsD(String[] array, String name){
		...
		this.setDefaultState(this.blockState.getBaseState().withProperty(VARIANT, EnumRocksD.values()[0]).withProperty(SUPPORT, EnumSupport.FULL));
    }
