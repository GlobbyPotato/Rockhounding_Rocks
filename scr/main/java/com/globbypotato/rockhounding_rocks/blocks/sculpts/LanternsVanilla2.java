...
public class LanternsVanilla2 extends LanternsIO{
	public static final PropertyEnum VARIANT = PropertyEnum.create("type", EnumVanilla2.class);

    public LanternsVanilla2(String[] array, String name){
		...
		this.setDefaultState(this.blockState.getBaseState().withProperty(VARIANT, EnumVanilla2.values()[0]).withProperty(SUPPORT, EnumSupport.FULL));
    }
