...
public class LanternsConcrete extends LanternsIO {
	public static final PropertyEnum VARIANT = PropertyEnum.create("type", EnumConcrete.class);

    public LanternsConcrete(String[] array, String name){
		...
		this.setDefaultState(this.blockState.getBaseState().withProperty(VARIANT, EnumConcrete.values()[0]).withProperty(SUPPORT, EnumSupport.FULL));
    }
