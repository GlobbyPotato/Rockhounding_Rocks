...
public class LanternsH extends LanternsIO {
	public static final PropertyEnum VARIANT = PropertyEnum.create("type", EnumRocksH.class);

    public LanternsH(String[] array, String name){
		...
		this.setDefaultState(this.blockState.getBaseState().withProperty(VARIANT, EnumRocksH.values()[0]).withProperty(SUPPORT, EnumSupport.FULL));
    }
