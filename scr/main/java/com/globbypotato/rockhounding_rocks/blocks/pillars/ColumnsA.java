...
import com.globbypotato.rockhounding_rocks.blocks.BaseColumns;
...
public class ColumnsA extends BaseColumns {
	public static final PropertyEnum VARIANT = PropertyEnum.create("type", EnumRocksA.class);

    public ColumnsA(String[] array, String name, boolean isTranslucent){
		...
		this.setDefaultState(this.blockState.getBaseState().withProperty(VARIANT, EnumRocksA.values()[0]).withProperty(POS, EnumPos.FULL));
    }
