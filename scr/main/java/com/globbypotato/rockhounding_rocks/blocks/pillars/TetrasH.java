...
import com.globbypotato.rockhounding_rocks.blocks.io.BaseTetras;
...
public class TetrasH extends BaseTetras {
    ...
    public TetrasH(String[] array, String name){
		...
		this.setDefaultState(this.blockState.getBaseState().withProperty(VARIANT, EnumRocksH.values()[0]).withProperty(POS, EnumPos.FULL));
    }
